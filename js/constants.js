...
const LIEN_LAW={
  ...
  DE:{prime:{d:180,txt:'180 days',anchor:'complete'},sub:{d:120,txt:'120 days'},enf:null,cite:'25 Del. C. 2711(a) / 2711(b) / 2714',src:'delcode.delaware.gov',url:'https://delcode.delaware.gov/title25/c027/sc02/index.html#2711',note:'Prime rate applies only to a direct contract covering BOTH labor and material. No enforcement deadline exists in the chapter: ask a lawyer.'},
  ...
  NC:{prime:{d:120,txt:'120 days',anchor:'last'},sub:null,enf:{d:180,txt:'180 days',anchor:'last'},cite:'N.C.G.S. 44A-12 / 44A-13 / 44A-11.2 / 44A-23',src:'ncleg.gov',url:'https://www.ncleg.gov/EnactedLegislation/Statutes/HTML/BySection/Chapter_44A/GS_44A-12.html',note:'Enforcement runs from last furnishing, NOT from filing. Notice to Lien Agent within 15 days of first furnishing.'},
