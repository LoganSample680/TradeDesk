...
const LIEN_LAW={
  ...
  GA:{prime:{d:90,txt:'90 days',anchor:'last'},sub:null,enf:{d:365,txt:'1 year',anchor:'filing'},cite:'O.C.G.A. 44-14-361.1(a)(2) / 44-14-361.5',src:'legis.ga.gov',url:'https://www.legis.ga.gov/api/legislation/document/20072008/83358',confirm:true,note:'The operative clause says only "90 days after the completion of the work" without saying whose. The claim form in the same paragraph answers it: the claim comes due on the last date YOU supplied labor, services or materials, and the Court of Appeals reads it the same way. File a notice with the clerk within 30 days of commencing the action or the lien dies.'},
