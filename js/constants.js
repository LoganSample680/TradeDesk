...
const LIEN_LAW={
  KS:{prime:{d:120,txt:'4 months',anchor:'last'},sub:{d:90,txt:'3 months'},enf:{d:365,txt:'1 year',anchor:'filing'},cite:'K.S.A. 60-1102 / 60-1103 / 60-1105',src:'ksrevisor.gov',url:'https://www.ksrevisor.gov/statutes/chapters/ch60/060_011_0002.html',note:'Filing a notice of extension inside the window buys 5 months on non-residential property.'},
  CT:{prime:{d:90,txt:'90 days',anchor:'last'},sub:{d:90,txt:'90 days'},enf:{d:365,txt:'1 year',anchor:'recording'},cite:'Conn. Gen. Stat. 49-34 / 49-35 / 49-39',src:'cga.ct.gov',url:'https://www.cga.ct.gov/current/pub/chap_847.htm',note:'Commencing the foreclosure is not enough: you must also record a notice of lis pendens inside the same year, or the lien dies. Serve a copy of the certificate on the owner within 30 days of lodging. Anyone who is not the original contractor owes the owner AND the contractor written notice of intent within 90 days of ceasing work.'},
  DE:{prime:{d:180,txt:'180 days',anchor:'complete'},sub:{d:120,txt:'120 days'},enf:null,cite:'25 Del. C. 2711(a) / 2711(b) / 2712(a) / 2714',src:'delcode.delaware.gov',url:'https://delcode.delaware.gov/title25/c027/sc02/index.html#2711',note:'There is no enforcement deadline because in Delaware the filing IS the lawsuit: 2712(a) makes the statement of claim serve as the complaint in Superior Court, so the 2711 filing dates are also your deadline to sue. Anchors split: a prime runs 180 days from completion of the STRUCTURE, everyone else 120 days from their own last work. What happens after filing is Superior Court rules, not this chapter.'},
  ME:{prime:{d:120,txt:'120 days (suit, nothing is recorded)',anchor:'last'},sub:{d:90,txt:'90 days to record'},enf:{d:120,txt:'120 days',anchor:'last'},cite:'10 M.R.S. 3253 / 3255',src:'legislature.maine.gov',url:'https://legislature.maine.gov/legis/statutes/10/title10sec3253.html',note:'A prime in privity with the owner records nothing and preserves the lien only by suing.'},
  MD:{prime:{d:180,txt:'180 days',anchor:'last'},sub:null,enf:{d:365,txt:'1 year',anchor:'filing'},cite:'Md. Real Prop. 9-105 / 9-104 / 9-109',src:'mgaleg.maryland.gov',url:'https://mgaleg.maryland.gov/mgawebsite/Laws/StatuteText?article=grp&section=9-105&enactments=false',note:'Court petition, nothing is recorded. Sub notice to owner within 120 days, single-family included.'},
  MA:{prime:{d:90,txt:'earliest of 60d after notice of substantial completion, 90d after termination, 90d after last work',anchor:'special'},sub:null,enf:{d:90,txt:'90 days',anchor:'statement_of_account'},cite:'M.G.L. c.254 s.2 / s.4 / s.8 / s.11',src:'malegislature.gov',url:'https://malegislature.gov/Laws/GeneralLaws/PartIII/TitleIV/Chapter254/Section2',note:'Two filings: Notice of Contract then Statement of Account.'},
  NH:{prime:{d:120,txt:'120 days',anchor:'last'},sub:null,enf:{d:120,txt:'120 days (the attachment IS the perfection)',anchor:'last'},cite:'N.H. RSA 447:9 / 447:10 / 447:5',src:'gc.nh.gov',url:'https://gc.nh.gov/rsa/html/XLI/447/447-9.htm',note:'Nothing is recorded. Secure by court attachment inside the 120 days.'},
  NJ:{prime:{d:90,txt:'90 days non-residential, 120 days residential',anchor:'last'},sub:null,enf:{d:365,txt:'1 year',anchor:'last'},cite:'N.J.S.A. 2A:44A-6 / 2A:44A-14 / 2A:44A-21',src:'lis.njleg.state.nj.us',url:'https://lis.njleg.state.nj.us/nxt/gateway.dll/statutes/1/112/1463',note:'The residential 120 days is not a deadline you can rely on: it is the outer half of a two part test, and the inner half (10 days from receiving the arbitrator determination) almost always fires first. New Jersey splits residential from commercial, not prime from sub. The enforcement year runs from your last work, NOT from filing, so filing on day 89 leaves nine months to sue, not twelve, and a warranty call does not reset it.'},
  NY:{prime:{d:240,txt:'8 months, 4 months on a single-family dwelling',anchor:'complete'},sub:null,enf:{d:365,txt:'1 year',anchor:'filing'},cite:'N.Y. Lien Law 10 / 17',src:'nysenate.gov',url:'https://www.nysenate.gov/legislation/laws/LIE/10',note:'A single-family lien can only be extended by court order.'},
  PA:{prime:{d:180,txt:'6 months',anchor:'contract_complete'},sub:{d:180,txt:'6 months'},enf:{d:730,txt:'2 years',anchor:'filing'},cite:'49 P.S. 1501 / 1501.3 / 1502 / 1701',src:'palegis.us',url:'https://www.palegis.us/statutes/unconsolidated/law-information/view-statute?txtType=HTM&yr=1963&sessInd=0&smthLwInd=0&act=497&chpt=5&sctn=2&subsctn=0',note:'"Completion of his work" is a defined term, not plain English. Section 201(8) makes it the last labor or last delivery required by YOUR OWN contract, so the six months runs from your contract, never from the whole project. A sub who finished in March is out in September even if the job runs another year. Serve notice of the filing on the owner within one month, and subs owe a 30 day notice of intention before filing.'},
  RI:{prime:{d:200,txt:'200 days',anchor:'last'},sub:null,enf:{d:40,txt:'40 days',anchor:'notice_of_intention'},cite:'R.I.G.L. 34-28-4 / 34-28-4.1 / 34-28-10',src:'rilegislature.gov',url:'https://webserver.rilegislature.gov/Statutes/TITLE34/34-28/34-28-4.htm',note:'ENFORCEMENT IS 40 DAYS. Complaint and lis pendens both, or the lien is void and wholly lost.'},
  VT:{prime:{d:180,txt:'180 days',anchor:'payment_due'},sub:null,enf:{d:180,txt:'180 days',anchor:'filing'},cite:'9 V.S.A. 1921(b) / 1921(c) / 1924',src:'findlaw',unverified:'legislature.vermont.gov returned 503 to roughly forty attempts over two hours, across curl, WebFetch and raw TLS, on the section page, the chapter page and the site root. Other vermont.gov hosts answered fine in the same second, so this is their server and not our egress. Vermont is the one jurisdiction still on a commercial republisher, and it is the one to re-read first when that site comes back.',confirm:true,note:'Runs from when payment became DUE, not from the last day of work, and this is the one state we could not read from its own legislature, so treat the date as a starting point rather than an answer.'},
  VA:{prime:{d:90,txt:'90 days from the last day of the month of last work, and never later than 90 days from completion',anchor:'month_end'},sub:null,enf:{d:180,txt:'6 months from recording or 60 days from completion, whichever is later',anchor:'special'},cite:'Va. Code 43-4 / 43-4.01 / 43-17',src:'law.lis.virginia.gov',url:'https://law.lis.virginia.gov/vacode/title43/chapter1/section43-4/',note:'150-day look-back: a memorandum cannot include sums furnished more than 150 days before your last day.'},
  DC:{prime:{d:90,txt:'90 days',anchor:'project_end'},sub:null,enf:{d:180,txt:'180 days',anchor:'notice_of_intent'},cite:'D.C. Code 40-301.02 / 40-303.13',src:'code.dccouncil.gov',url:'https://code.dccouncil.gov/us/dc/council/code/sections/40-301.02',note:'Anchor is the earlier of completion or termination of the PROJECT, not your own last day.'},
  AL:{prime:{d:180,txt:'6 months',anchor:'last'},sub:{d:120,txt:'4 months'},enf:{d:180,txt:'6 months',anchor:'debt_maturity'},cite:'Ala. Code 35-11-213 / 35-11-215 / 35-11-218 / 35-11-221',src:'alison.legislature.state.al.us',url:'https://alison.legislature.state.al.us/code-of-alabama',note:'Three tiers, not two: an original contractor gets 6 months, a journeyman or day laborer 30 days, and everyone else 4 months from their own last item. The enforcement clock is the odd one: it runs from maturity of the ENTIRE indebtedness, not from filing, so a lien filed early can still expire on a schedule the filing date never predicts.'},
  AR:{prime:{d:120,txt:'120 days',anchor:'last'},sub:null,enf:null,cite:'Ark. Code 18-44-117 / 18-44-114 / 18-44-115 (enforcement is 18-44-119, unverified)',src:'arkleg.state.ar.us',url:'https://www.arkleg.state.ar.us/Home/FTPDocument?path=/ACTS/2007/Public/ACT810.pdf',confirm:true,note:'18-44-117 says 120 days after the things are furnished or the work done, without saying whose. Arkansas publishes its code through a commercial service rather than on a state site, so this comes from the enacted session law and the enforcement deadline in 18-44-119 could not be read from any state source at all. Everyone owes the owner 10 days notice before filing.'},
  FL:{prime:{d:90,txt:'90 days',anchor:'last'},sub:null,enf:{d:365,txt:'1 year',anchor:'filing'},cite:'Fla. Stat. 713.08 / 713.06 / 713.22',src:'flsenate.gov',url:'https://www.flsenate.gov/Laws/Statutes/2024/713.08',note:'If the contract is terminated under 713.07(4) it is the EARLIER of 90 days from termination or from final furnishing. Non-primes: 45-day Notice to Owner or the lien is unenforceable.'},
  GA:{prime:{d:90,txt:'90 days',anchor:'last'},sub:null,enf:{d:365,txt:'365 days',anchor:'filing'},cite:'O.C.G.A. 44-14-361.1(a)(2),(a)(3)',src:'legis.ga.gov',url:'https://www.legis.ga.gov/api/legislation/document/20072008/83358',confirm:true,note:'The statute says "after the completion of the work" with no possessive and never says whose, so the your-own-work reading comes from Georgia case law, not the text. The lien form in the same paragraph points the same way but defines when the claim came DUE, which is not the same as what starts the 90 days. Separately, within 30 days of suing you must file a notice of commencement of lien action with the clerk or the lien dies.'},
  KY:{prime:{d:180,txt:'6 months',anchor:'last'},sub:null,enf:{d:365,txt:'12 months',anchor:'filing'},cite:'KRS 376.080(1) / 376.090(1) / 376.010(4),(5)',src:'apps.legislature.ky.gov',url:'https://apps.legislature.ky.gov/law/statutes/statute.aspx?id=35289',note:'Filing is not enough: 376.080(1) dissolves the lien outright unless you mail the owner a copy within seven days of filing. Prime and sub share the same six months. The role split is in the preliminary notice: if you did not contract with the owner, 75 days on claims under $1,000, 120 days over, and 75 days flat on a single or double family home.'},
  LA:{prime:{d:60,txt:'60 days by default, 7 months only if a notice of contract was filed',anchor:'project_end'},sub:{d:30,txt:'30 days after a notice of termination, or 6 months'},enf:{d:365,txt:'1 year',anchor:'filing'},cite:'La. R.S. 9:4822 / 9:4823',src:'legis.la.gov',url:'https://legis.la.gov/legis/Law.aspx?d=108062',note:'The 75-day supplier notice was REPEALED in 2019. No mandatory preliminary notice now.'},
  MS:{prime:{d:90,txt:'90 days',anchor:'last'},sub:{d:90,txt:'90 days'},enf:{d:180,txt:'180 days',anchor:'filing'},cite:'Miss. Code 85-7-405(1)(b),(c)(i) / 85-7-407(2) / 85-7-409(2)',src:'billstatus.ls.state.ms.us',url:'https://billstatus.ls.state.ms.us/documents/2014/pdf/SB/2600-2699/SB2622SG.pdf',note:'Prime and sub share one 90 day deadline, there is no role split. The trap is 85-7-407(2): anyone NOT in privity with the contractor, a sub-sub or a supplier to a sub, must notify the contractor within 30 days of FIRST delivery or the lien is forfeited outright, and that clock starts at the beginning of the job rather than the end.'},
  NC:{prime:{d:120,txt:'120 days',anchor:'last'},sub:{d:120,txt:'120 days'},enf:{d:180,txt:'180 days',anchor:'last'},cite:'N.C.G.S. 44A-12(b) / 44A-13(a) / 44A-11.2 / 44A-23(a),(d)',src:'ncleg.gov',url:'https://www.ncleg.gov/EnactedLegislation/Statutes/HTML/BySection/Chapter_44A/GS_44A-12.html',note:'44A-12(b) states the 120 days outright and anchors it to last furnishing "by the person claiming the lien." A sub files the CONTRACTOR\'s lien by subrogation under 44A-23, and 44A-23(d) lets the sub use either its own last furnishing date or the contractor\'s, which can only help. Enforcement runs from last furnishing, NOT from filing. Notice to Lien Agent within 15 days of first furnishing.'},
  SC:{prime:{d:90,txt:'90 days, and you must SERVE the owner as well as file',anchor:'last'},sub:null,enf:{d:180,txt:'6 months',anchor:'ceasing_labor'},cite:'S.C. Code 29-5-90 / 29-5-120 / 29-5-20',src:'scstatehouse.gov',url:'https://www.scstatehouse.gov/code/t29c005.php',note:'ENFORCEMENT RUNS FROM CEASING TO LABOUR, not from filing. File late and most of the window is already gone.'},
  TN:{prime:{d:90,txt:'90 days',anchor:'complete'},sub:{d:90,txt:'90 days'},enf:{d:365,txt:'1 year (prime only)',anchor:'complete'},cite:'Tenn. Code 66-11-112(a) / 66-11-115(a)(2),(b) / 66-11-145(a) / 66-11-146',src:'capitol.tn.gov',url:'https://www.capitol.tn.gov/Bills/105/Chapter/PC0189.pdf',note:'A remote contractor gets 90 days from SERVING its notice of lien to sue, not the prime one year, and forfeits the lien outright unless it served a notice of nonpayment within 90 days of the last day of EVERY month it worked unpaid. On owner-occupied property of four units or fewer, 66-11-146 bars subcontractor liens entirely: only the prime can lien.'},
  WV:{prime:{d:100,txt:'100 days',anchor:'contract_complete'},sub:{d:100,txt:'100 days from completion of the subcontract'},enf:{d:180,txt:'6 months',anchor:'filing'},cite:'W. Va. Code 38-2-8 / 38-2-9 / 38-2-11 / 38-2-34',src:'code.wvlegislature.gov',url:'https://code.wvlegislature.gov/38-2-8/',note:'No mandatory preliminary notice: 38-2-20 is permissive. Non-primes must serve the owner AND record inside the 100 days.'},
  OH:{prime:{d:75,txt:'75 days, 60 days on a one or two family dwelling',anchor:'last'},sub:null,enf:{d:2190,txt:'6 years, or 60 days after a notice to commence suit',anchor:'filing'},cite:'O.R.C. 1311.06 / 1311.05 / 1311.13 / 1311.11',src:'codes.ohio.gov',url:'https://codes.ohio.gov/ohio-revised-code/section-1311.06',note:'Subs owe a 21-day notice of furnishing only if a notice of commencement was recorded.'},
  IL:{prime:{d:120,txt:'4 months',anchor:'contract_complete'},sub:{d:120,txt:'4 months'},enf:{d:730,txt:'2 years',anchor:'contract_complete'},cite:'770 ILCS 60/7(a) / 60/21(a) / 60/24(a) / 60/25 / 60/28 / 60/9',src:'ilga.gov',url:'https://www.ilga.gov/Legislation/ILCS/Articles?ActID=2254&ChapterID=63',confirm:true,note:'The 4 months and the 2 years are not alternatives, they are two different defendants. Miss 4 months and the lien survives against the owner but dies against every other creditor, encumbrancer or purchaser, which in practice means any lender or buyer, so 4 months is the only safe number. A sub records on the same clock as the prime; the separate 90 days in 60/24 is a NOTICE to the owner, not a recording deadline.'},
  IN:{prime:{d:60,txt:'60 days on a one or two unit home, 90 days otherwise',anchor:'last'},sub:{d:60,txt:'60 days on a one or two unit home, 90 days otherwise'},enf:{d:365,txt:'1 year',anchor:'recording'},cite:'IC 32-28-3-3(a),(b) / 32-28-3-6(a) / 32-28-3-1(h),(i) / 32-28-3-10',src:'iga.in.gov',url:'https://iga.in.gov/ic/2026/2026-Indiana-Code-html.zip',note:'Residential is 60 days, not 90, and that covers most trade work: a Class 2 structure is a townhouse or any building of one or two dwelling units plus its outbuildings. On credit sales a condition precedent fires first: 30 days from first delivery to notify an owner-occupant on alteration or repair, 60 days plus a recorded copy on original construction. Miss that notice and no lien can ever attach. Any owner or lienholder can also cut the enforcement year to 30 days by written demand.'},
  IA:{prime:{d:90,txt:'90 days for a full-strength lien',anchor:'last'},sub:null,enf:{d:820,txt:'2 years from the end of the 90 days',anchor:'last'},cite:'Iowa Code 572.9 / 572.10 / 572.11 / 572.27',src:'legis.iowa.gov',url:'https://www.legis.iowa.gov/docs/code/572.9.pdf',note:'A lien posted after 90 days is still good but is capped at the balance the owner still owes the GC. Outer limit is 2 years and 90 days.'},
  MI:{prime:{d:90,txt:'90 days',anchor:'last'},sub:{d:90,txt:'90 days'},enf:{d:365,txt:'1 year',anchor:'filing'},cite:'MCL 570.1111(1) / 570.1117(1) / 570.1109',src:'legislature.mi.gov',url:'https://www.legislature.mi.gov/Laws/MCL?objectName=mcl-570-1111',note:'One 90 day rule covers prime and sub alike, but two service traps sit outside it: a sub or supplier owes a notice of furnishing within 20 days of FIRST furnishing or the lien is cut down to whatever the owner already paid out, and everyone must serve the recorded lien on the designee within 15 days of recording.'},
  MN:{prime:{d:120,txt:'120 days',anchor:'last'},sub:null,enf:{d:365,txt:'1 year',anchor:'last_item'},cite:'Minn. Stat. 514.08 / 514.011 / 514.12',src:'revisor.mn.gov',url:'https://www.revisor.mn.gov/statutes/cite/514.08',note:'Contractor notice in the contract or within 10 days, else no lien. Sub notice to owner within 45 days is a prerequisite to any claim.'},
  MO:{prime:{d:180,txt:'6 months',anchor:'debt_accrued'},sub:null,enf:{d:180,txt:'6 months',anchor:'filing'},cite:'RSMo 429.080 / 429.170 / 429.012 / 429.100',src:'revisor.mo.gov',url:'https://revisor.mo.gov/main/OneSection.aspx?section=429.080',note:'Six months for original contractors, day laborers and every other person alike. The old 4-month figure for non-primes is superseded. Rented equipment is 60 days.'},
  NE:{prime:{d:120,txt:'120 days',anchor:'last'},sub:null,enf:{d:730,txt:'2 years, or 30 days after a written demand',anchor:'recording'},cite:'Neb. Rev. Stat. 52-137 / 52-140 / 52-135 / 52-136',src:'nebraskalegislature.gov',url:'https://nebraskalegislature.gov/laws/statutes.php?statute=52-137',note:'Preliminary notice is OPTIONAL. Against a protected-party owner its absence caps the lien rather than voiding it.'},
  ND:{prime:{d:90,txt:'90 days',anchor:'last'},sub:null,enf:{d:1095,txt:'3 years, and a lis pendens must be recorded too',anchor:'recording'},cite:'N.D.C.C. 35-27-13 / 35-27-14 / 35-27-25 / 35-27-02',src:'ndlegis.gov',url:'https://www.ndlegis.gov/cencode/t35c27.pdf',note:'Missing 90 days does not defeat the lien except against good-faith purchasers and payments already made. Separate outer bar: no filing more than 3 years after the FIRST item.'},
  OK:{prime:{d:120,txt:'4 months',anchor:'last'},sub:{d:90,txt:'90 days'},enf:{d:365,txt:'1 year',anchor:'filing'},cite:'42 O.S. 142 / 143 / 142.6 / 172',src:'oksenate.gov',url:'https://oksenate.gov/sites/default/files/2019-12/os42.pdf',note:'Non-primes owe a pre-lien notice within 75 days of last supply. Always required on an owner-occupied dwelling or the lien is invalid.'},
  SD:{prime:{d:120,txt:'120 days',anchor:'last'},sub:null,enf:{d:2190,txt:'6 years',anchor:'last_item'},cite:'SDCL 44-9-15 / 44-9-24 / 44-9-53',src:'sdlegislature.gov',url:'https://sdlegislature.gov/Statutes/44-9-15',note:'Enforcement runs from the last item of the claim, not from filing. Notice of furnishing only applies if a notice of project commencement was filed.'},
  WI:{prime:{d:180,txt:'6 months',anchor:'last'},sub:null,enf:{d:730,txt:'2 years',anchor:'filing'},cite:'Wis. Stat. 779.06 / 779.02',src:'docs.legis.wisconsin.gov',url:'https://docs.legis.wisconsin.gov/statutes/statutes/779/I/06',note:'Non-primes must give notice within 60 days of first furnishing or there is no lien. All claimants owe a 30-day notice of intent before filing.'},
  AK:{prime:{d:120,txt:'120 days',anchor:'last'},sub:null,enf:{d:180,txt:'6 months',anchor:'recording'},cite:'AS 34.35.068 / 34.35.080 / 34.35.064',src:'akleg.gov',url:'https://www.akleg.gov/basis/statutes.asp#34.35.068',note:'If the owner records a notice of completion the window collapses to 15 days, unless you recorded a notice of right to lien first. That notice is what protects the 120 days.'},
  AZ:{prime:{d:120,txt:'120 days',anchor:'complete'},sub:null,enf:{d:180,txt:'6 months',anchor:'recording'},cite:'A.R.S. 33-993 / 33-992.01 / 33-998 / 33-1002',src:'azleg.gov',url:'https://www.azleg.gov/ars/33/00993.htm',note:'A recorded notice of completion cuts EVERYONE to 60 days. The 20-day preliminary notice is required of the general contractor too, and no sub can lien an owner-occupied home without a written contract with the owner (33-1002).'},
  CA:{prime:{d:90,txt:'90 days',anchor:'complete'},sub:null,enf:{d:90,txt:'90 days',anchor:'recording'},cite:'Cal. Civ. Code 8412 / 8414 / 8200 / 8460',src:'leginfo.legislature.ca.gov',url:'https://leginfo.legislature.ca.gov/faces/codes_displaySection.xhtml?lawCode=CIV&sectionNum=8412',note:'A recorded notice of completion cuts the prime to 60 days and everyone else to 30. Enforcement is only 90 days from recording the lien, then it expires by operation of law.'},
  CO:{prime:{d:120,txt:'4 months',anchor:'last'},sub:null,enf:{d:180,txt:'6 months',anchor:'complete'},cite:'C.R.S. 38-22-109(4),(5) / 38-22-110 / 38-22-125',src:'leg.colorado.gov',url:'https://leg.colorado.gov/sites/default/files/images/olls/crs2024-title-38.pdf',note:'Colorado has no notice of completion at all. The shortener is 38-22-125: on a one or two family dwelling a lien filed more than two months after completion does not bind a buyer, and the dwelling counts as complete on conveyance and occupancy, so a closing can start a two month gun while your own four months is still running. The only role split is day or piece laborers furnishing no materials, who get two months from completion of the BUILDING.'},
  HI:{prime:{d:45,txt:'45 days',anchor:'complete'},sub:null,enf:{d:90,txt:'3 months after the order directing the lien to attach',anchor:'court_order'},cite:'HRS 507-43',src:'capitol.hawaii.gov',url:'https://www.capitol.hawaii.gov/hrscurrent/vol12_ch0501-0588/HRS0507/HRS_0507-0043.htm',note:'The clock starts when a notice of completion is PUBLISHED and filed. If none is ever published the date of completion is deemed one year after actual completion, so the real window can run past a year.'},
  ID:{prime:{d:90,txt:'90 days',anchor:'last'},sub:null,enf:{d:180,txt:'6 months',anchor:'filing'},cite:'Idaho Code 45-507(2) / 45-510 / 45-525',src:'legislature.idaho.gov',url:'https://legislature.idaho.gov/statutesrules/idstat/Title45/T45CH5/SECT45-507/',confirm:true,note:'45-507(2) gives 90 days after "the completion of the labor or services" and never says whose, and nothing else in the chapter defines it. Franklin Building Supply v. Sumpter (2004) settles it as substantial completion of YOUR OWN contract and expressly refuses to use the certificate of occupancy, so the date turns on when your contract was substantially done, punch list included.'},
  MT:{prime:{d:90,txt:'90 days',anchor:'last'},sub:null,enf:{d:730,txt:'2 years',anchor:'filing'},cite:'MCA 71-3-535(1) / 71-3-533(2) / 71-3-531 / 71-3-562',src:'archive.legmt.gov',url:'https://archive.legmt.gov/bills/mca/title_0710/chapter_0030/part_0050/section_0350/0710-0030-0050-0350.html',confirm:true,note:'The owner can start your clock for you. 71-3-535(1)(b) runs the 90 days from the owner filing a notice of completion, and 71-3-533(2) counts a mere 30 day cessation of labor as completion, so a winter gap on a job you still intend to finish can open the window early. Separately, if you owed a notice of right to claim lien it must be UNEXPIRED on record the moment you file, and it lapses after one year.'},
  NV:{prime:{d:90,txt:'90 days',anchor:'complete'},sub:null,enf:{d:180,txt:'6 months',anchor:'recording'},cite:'NRS 108.226 / 108.245 / 108.233',src:'leg.state.nv.us',url:'https://www.leg.state.nv.us/NRS/NRS-108.html#NRS108Sec226',note:'A recorded and served notice of completion cuts it to 40 days. On residential work a 15-day notice of intent is required and serving it EXTENDS your recording deadline by 15 days.'},
  NM:{prime:{d:120,txt:'120 days',anchor:'contract_complete'},sub:{d:90,txt:'90 days'},enf:{d:730,txt:'2 years',anchor:'filing'},cite:'NMSA 1978 48-2-6(A),(B) / 48-2-2.1 / 48-2-10',src:'nmonesource.com',url:'https://nmonesource.com/nmos/nmsa/en/item/4413/index.do',note:'The anchors differ by role and this is the part secondary sources get wrong: a prime runs 120 days from completion of its OWN contract, a sub runs 90 days from completion of the BUILDING. A sub who finished rough-in in March on a job that tops out in October is still timely in October. Since 2023 you must also serve a copy of the filed lien on the owner within 15 days or you can lose interest, fees and costs.'},
  OR:{prime:{d:75,txt:'75 days',anchor:'last'},sub:null,enf:{d:120,txt:'120 days, and never more than 2 years',anchor:'filing'},cite:'ORS 87.035 / 87.021 / 87.093 / 87.055',src:'oregonlegislature.gov',url:'https://www.oregonlegislature.gov/bills_laws/ors/ors087.html',note:'An original contractor on a residential job over $2,000 who does not hand over the Information Notice to Owner at signing may not claim any lien at all.'},
  TX:{prime:{d:75,txt:'the 15th day of the 3rd month after the month your work ended (residential) or the 4th month (non-residential)',anchor:'special'},sub:null,enf:{d:365,txt:'1 year from the last day you could have filed',anchor:'special'},cite:'Tex. Prop. Code 53.052 / 53.056 / 53.158',src:'statutes.capitol.texas.gov',url:'https://statutes.capitol.texas.gov/Docs/PR/htm/PR.53.htm#53.052',note:'NOT a day count. The 75 here is the earliest that window can close, so a warning fires in time. 53.053 and 53.252 were REPEALED by HB 2237 effective 2022; the sub notice is now the 15th of the 3rd month non-residential, 2nd month residential.'},
  UT:{prime:{d:180,txt:'180 days',anchor:'contract_complete'},sub:null,enf:{d:180,txt:'180 days, with a notice of pendency recorded too',anchor:'filing'},cite:'Utah Code 38-1a-502 / 38-1a-501 / 38-1a-701',src:'le.utah.gov',url:'https://le.utah.gov/xcode/Title38/Chapter1A/38-1a-S502.html',note:'A preliminary notice in the State Construction Registry within 20 days of starting is required of EVERYONE, original contractors included, or there is no lien. A filed notice of completion cuts it to 90 days.'},
  WA:{prime:{d:90,txt:'90 days',anchor:'last'},sub:null,enf:{d:240,txt:'8 months',anchor:'recording'},cite:'RCW 60.04.091 / 60.04.031 / 60.04.141',src:'app.leg.wa.gov',url:'https://app.leg.wa.gov/RCW/default.aspx?cite=60.04.091',note:'No preliminary notice if you contract directly with the owner or with the prime. For everyone else it is a lookback, protecting only what was supplied in the 60 days before it was sent (10 days on a new single-family home).'},
  WY:{prime:{d:150,txt:'150 days',anchor:'last'},sub:{d:120,txt:'120 days'},enf:{d:180,txt:'180 days',anchor:'filing'},cite:'Wyo. Stat. 29-2-106 / 29-2-112 / 29-2-107 / 29-2-109',src:'wyoleg.gov',url:'https://www.wyoleg.gov/statutes/compress/title29.pdf',note:'THE CONTRACTOR MUST SEND NOTICE BEFORE TAKING ANY PAYMENT, advances included, or the lien is barred outright. Subs and materialmen: within 30 days of first providing.'},
};
