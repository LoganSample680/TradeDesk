...
const LIEN_LAW={
  ...
  VT:{prime:{d:180,txt:'180 days',anchor:'payment_due'},sub:null,enf:{d:180,txt:'180 days',anchor:'filing_or_payment_due'},cite:'9 V.S.A. 1921(c) / 1924',src:'legislature.vermont.gov',url:'https://legislature.vermont.gov/statutes/section/09/051/01921',note:'The clock runs from when payment became DUE for your last labor or materials, not from the day you finished, which is the one anchor of its kind in the country. Enforcement is 180 days from filing the memorandum if payment was already due when you filed, otherwise 180 days from when it becomes due.'},
