...
<div class="proposal" style="background:#fff;color:#1a1a1a;border-radius:10px;overflow:hidden;border:1px solid #e2e8f0;box-shadow:0 4px 24px rgba(0,0,0,.10)">
  ...
  <div style="padding:16px 24px;border-top:2px dashed #94a3b8;background:#fff">
    <div style="text-align:center;font-size:9px;font-weight:700;text-transform:uppercase;letter-spacing:.14em;color:#94a3b8;margin-bottom:10px;border-bottom:1px dashed #cbd5e1;padding-bottom:8px">✂ Detach &amp; Retain — Notice of Cancellation (${_cancelStat} / 16 CFR Part 429)</div>
