...
function _buildClientHubSnapshot(clientId){
  ...
  const snapshotBids=cbids.map(b=>{
    ...
    return {id:b.id,amount:b.amount||0,deposit:Math.round((b.amount||0)*0.25*100)/100,status:b.status,type:_hubType,bid_date:b.bid_date||'',completion_date:b.completion_date||'',paid,balance,signedAt:b.signedAt||'',
...
<div class="proposal" style="background:#fff;color:#1a1a1a;border-radius:10px;overflow:hidden;border:1px solid #e2e8f0;box-shadow:0 4px 24px rgba(0,0,0,.10)">
  ...
  <div style="padding:12px 24px;border-top:3px solid #92400E;background:#FEF3C7">
    <div style="font-size:9.5px;font-weight:800;text-transform:uppercase;letter-spacing:.06em;color:#92400E;margin-bottom:6px">⚠ Kansas Consumer Protection Act — Required Notice</div>
    <div style="font-size:10.5px;font-weight:800;color:#1a1a1a;line-height:1.65;border:2px solid #92400E;padding:9px 11px;border-radius:3px;background:#fff">YOU, THE BUYER, MAY CANCEL THIS TRANSACTION AT ANY TIME PRIOR TO MIDNIGHT OF THE THIRD BUSINESS DAY AFTER THE DATE OF THIS TRANSACTION. SEE THE NOTICE OF CANCELLATION FORM AT THE BOTTOM OF THIS DOCUMENT FOR AN EXPLANATION OF THIS RIGHT.</div>
  </div>
  <div style="padding:18px 24px;border-top:1px solid #e2e8f0;background:#f8fafc">
    ...
    <div style="font-size:10.5px;color:#4a5568;line-height:1.85">
      <p style="margin:0 0 7px"><strong>1. Payment:</strong> A 25% deposit is required before any work begins and before a start date will be scheduled. The remaining balance is due upon completion of work.</p>
      <p style="margin:0 0 9px"><strong>2. Cancellation &amp; Deposits:</strong> Buyer has the right to cancel this transaction without penalty within three (3) business days of signing (K.S.A. 50-640). After the three-business-day cancellation period, the deposit is retained as liquidated damages to compensate for: (a) <em>Mobilization &amp; Scheduling</em> — reserving crew availability and declining other projects for the contracted dates; (b) <em>Administrative Costs</em> — time invested in site measurements, color consulting, and preparation of this written scope; and (c) <em>Material Procurement</em> — sourcing specific paint colors and materials that may not be returnable or transferable to other jobs. These represent a reasonable good-faith estimate of actual damages, not a penalty. If cancellation occurs after materials have been purchased, contractor will make all materials available for client pickup at no additional charge.</p>
      ...
      <p style="margin:0">By signing, client acknowledges receipt of the Notice of Cancellation form below, full agreement with all scope, pricing, and terms, and that this constitutes a legally binding electronic agreement pursuant to K.S.A. 16-1601 et seq.</p>
    </div>
  </div>
  <div style="padding:16px 24px;border-top:2px dashed #94a3b8;background:#fff">
    <div style="text-align:center;font-size:9px;font-weight:700;text-transform:uppercase;letter-spacing:.14em;color:#94a3b8;margin-bottom:10px;border-bottom:1px dashed #cbd5e1;padding-bottom:8px">✂ Detach &amp; Retain — Notice of Cancellation (K.S.A. 50-640)</div>
