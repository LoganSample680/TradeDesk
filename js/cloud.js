...
function _lpDoDelete(id,type){
  ...
  else if(type==='bid'){bids=bids.filter(x=>x.id!==nid);_flushSaveNow&&_flushSaveNow();if(typeof renderJobsHistory==='function')renderJobsHistory();}
}
