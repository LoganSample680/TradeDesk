...
function _bootSyncSettled(){
  ...
  // The client list just landed: publish it to iOS caller ID (js/callerid.js).
  // Well after the pour so it never competes with the boot render.
  try{if(typeof _callerIdSyncSoon==='function')_callerIdSyncSoon(5000);}catch(_e){}
}
